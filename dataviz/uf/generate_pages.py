...
<body>
  ...
  <div class="uf-brightness">
    <div class="uf-slider-row">
      ...
      <input type="range" id="opacity" min="0.1" max="2" step="0.01" value="1">
    </div>
    <div class="uf-slider-row">
    ...
    <div class="uf-zoom-row">zoom <span id="zoomval">-</span> &middot; r <span id="rval">-</span> &middot; a <span id="aval">-</span> &middot; g <span id="gval">-</span></div>
  </div>
